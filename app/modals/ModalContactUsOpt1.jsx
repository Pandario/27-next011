...
<label className='map-input'>
                    <input
                          ...
                          name="checkbox"
                          value="Camp"
                          checked={checkbox === 'Camp1'}
                          onChange={() => handleRadioChange('Camp1')}
                      />
                      Camp house #1
                    <input
                        type="radio"
                        ...
                        name="checkbox"
                        value="Camp2"
                        checked={checkbox === 'Camp2'}
                        onChange={() => handleRadioChange('Camp2')}
                    />
                    Camp house #2
                    <input
                        type="radio"
                        ...
                        name="checkbox"
                        value="Camp3"
                        checked={checkbox === 'Camp3'}
                        onChange={() => handleRadioChange('Camp3')}
                    />
                    Camp house #3
                  </label>
            <textarea
